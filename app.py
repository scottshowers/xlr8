...
if 'llm_password' not in st.session_state:
    st.session_state.llm_password = "Argyle76226#"
    ...
    with analysis_tab1:
        ...
        with analysis_tab2:
            ...
            window.addEventListener('load', function() {
                ...
                const savedUsername = localStorage.getItem('xlr8_llm_username');
                const savedPassword = localStorage.getItem('xlr8_llm_password');
            ...
            function saveConfig() {
                ...
                if (usernameInput) {
                    localStorage.setItem('xlr8_llm_username', usernameInput.value);
                }
                if (passwordInput) {
                    localStorage.setItem('xlr8_llm_password', passwordInput.value);
                }
            }
            ...
            setTimeout(function() {
                ...
                if (usernameInput) {
                    ...
                    usernameInput.addEventListener('blur', saveConfig);
                }
                if (passwordInput) {
                    passwordInput.addEventListener('change', saveConfig);
                    passwordInput.addEventListener('blur', saveConfig);
                }
            }, 1000);
            </script>
            """, unsafe_allow_html=True)
