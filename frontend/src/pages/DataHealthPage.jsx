 ...
 * 
 * RENAMED: Data Model → Data Health
 * 
 * TWO SECTIONS:
 ...
 * 
 * Deploy to: frontend/src/pages/DataHealthPage.jsx
 */
    ...
    <div className={`space-y-6 ${embedded ? '' : 'p-6'}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">{activeProject.name} • Integrity checks + relationships</p>
        </div>
        <button
