  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-5xl mx-auto flex flex-col h-[calc(100vh-120px)]">
        ...
        {/* Messages Area */}
        <div className="flex-1 overflow-y-auto bg-gray-900 border-x border-gray-700 p-4 space-y-4">
          {messages.length === 0 ? (
        ...
        {/* Error Banner */}
        {error && (
          <div className="bg-red-900/50 border-x border-red-700 p-3 flex items-center gap-2">
