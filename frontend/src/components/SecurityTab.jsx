...
export default function SecurityTab() {
  ...
  const styles = {
    ...
    message: {
      ...
      borderRadius: 8,
      marginBottom: '1rem',
      background: message?.type === 'error' ? 'rgba(138, 74, 74, 0.1)' : 'rgba(90, 138, 90, 0.1)',
      color: message?.type === 'error' ? '#8a4a4a' : '#5a8a5a',
      border: `1px solid ${message?.type === 'error' ? 'rgba(138, 74, 74, 0.3)' : 'rgba(90, 138, 90, 0.3)'}`,
    },
    header: {
      display: 'flex',
    ...
    tab: (active) => ({
      padding: '0.5rem 1rem',
      border: 'none',
      background: active ? 'rgba(90, 138, 90, 0.1)' : 'transparent',
      color: active ? '#5a8a5a' : '#64748b',
      borderRadius: 6,
      cursor: 'pointer',
      fontWeight: 500,
      fontSize: '0.875rem',
    ...
    summaryCard: (level) => ({
      padding: '1rem',
      borderRadius: 8,
      background: level === 2 ? 'rgba(138, 74, 74, 0.1)' : level === 1 ? 'rgba(138, 107, 74, 0.1)' : 'rgba(90, 138, 90, 0.1)',
      border: `1px solid ${level === 2 ? 'rgba(138, 74, 74, 0.3)' : level === 1 ? 'rgba(138, 107, 74, 0.3)' : 'rgba(90, 138, 90, 0.3)'}`,
    }),
    summaryValue: (level) => ({
      fontSize: '1.5rem',
      fontWeight: 700,
      color: level === 2 ? '#8a4a4a' : level === 1 ? '#8a6b4a' : '#5a8a5a',
    }),
    summaryLabel: {
      fontSize: '0.75rem',
      color: '#64748b',
    ...
    toggle: (enabled, saving) => ({
      ...
      height: 26,
      borderRadius: 13,
      background: enabled ? '#5a8a5a' : '#cbd5e1',
      border: 'none',
    ...
    badge: (type) => ({
      ...
      fontSize: '0.65rem',
      fontWeight: 600,
      background: type === 'safe' ? 'rgba(90, 138, 90, 0.1)' : type === 'caution' ? 'rgba(138, 107, 74, 0.1)' : '#f1f5f9',
      color: type === 'safe' ? '#5a8a5a' : type === 'caution' ? '#8a6b4a' : '#64748b',
      marginLeft: '0.5rem',
    }),
    auditTable: {
      width: '100%',
    ...
    statusDot: (success) => ({
      ...
      height: 8,
      borderRadius: '50%',
      background: success ? '#5a8a5a' : '#8a4a4a',
      marginRight: '0.5rem',
    }),
    button: {
      padding: '0.5rem 1rem',
