...
class ResponseSynthesizer:
    ...
    def build_enhanced_prompt(self,
        ...
        if chromadb_context:
            ...
            # No context available - be clear about limitations
            prompt_parts.append("\nINSTRUCTIONS:")
            prompt_parts.append("Answer the question as completely as possible using your general knowledge.")
            prompt_parts.append("If the question is specific to UKG Pro/WFM implementation details, acknowledge that HCMPACT-specific documentation would provide more detailed guidance.")
