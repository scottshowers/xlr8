...
# Supabase client - import with fallback
try:
    ...
    try:
        ...
        logger.warning("[REFERENCE] Could not import supabase_client")
        def get_supabase():
            return None
...
@router.get("/projects/{customer_id}/context", response_model=ProjectContextResponse)
...
@router.post("/projects/{customer_id}/context/confirm")
...
@router.post("/projects/{customer_id}/detect")
