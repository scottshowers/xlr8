...
### ~~COUNT(*) vs COUNT(DISTINCT employeeId)~~
**Resolved:** January 25, 2026
**Solution:** Fixed LLM prompt to always use COUNT(DISTINCT "employeeId") for employee counts. Added safety net in `_clean_sql()` that catches any COUNT(*) on employee tables and converts automatically.
...
### 2. Terminated Queries Don't Filter by Year
...
### 9. Old Intelligence Files Still in Tree
