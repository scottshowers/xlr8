...
# Project Intelligence Service (Phase 3.6)
try:
    from backend.utils.project_intelligence import get_project_intelligence
    INTELLIGENCE_AVAILABLE = True
    logger.info("[PLAYBOOKS] Project intelligence imported successfully")
except ImportError:
    try:
        from utils.project_intelligence import get_project_intelligence
        INTELLIGENCE_AVAILABLE = True
        logger.info("[PLAYBOOKS] Project intelligence imported (alt path)")
    except ImportError:
