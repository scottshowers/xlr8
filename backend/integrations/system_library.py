...
UKG_PRO = SystemDefinition(
    ...
    auth_fields=[
        {"name": "hostname", "label": "Service Hostname", "type": "text", "required": True, 
         "help": "From System Config > Security > Web Services (e.g., service5.ultipro.com)"},
        {"name": "customer_api_key", "label": "Customer API Key", "type": "text", "required": True,
         "help": "5-character key from Web Services config"},
        ...
        {"name": "user_api_key", "label": "User API Key", "type": "password", "required": True,
         "help": "API key assigned to the service account"},
    ],
    base_url_template="https://{hostname}",
    ...
    endpoints=[
        ...
        APIEndpoint(
            ...
            path="/configuration/v1/marital-status",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="gender",
            ...
            path="/configuration/v1/genders",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="employment_status",
            name="Employment Status",
            description="Employment status codes (Active, Terminated, LOA)",
            path="/configuration/v1/employment-status",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="pay_frequency",
            name="Pay Frequency",
            description="Pay frequency codes",
            path="/configuration/v1/pay-frequencies",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="deduction_codes",
            name="Deduction Codes",
            description="Deduction code definitions",
            path="/configuration/v1/deductions",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="job_families",
            name="Job Families",
            description="Job family groupings",
            path="/configuration/v1/job-family",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="pay_groups",
        ...
        APIEndpoint(
            id="supervisor_types",
            name="Supervisor Types",
            description="Supervisor/manager type codes",
            path="/configuration/v1/supervisor-types",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="citizenship_status",
            name="Citizenship Status",
            description="Citizenship/work authorization codes",
            path="/configuration/v1/citizenship-status",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="education_level",
            name="Education Level",
            description="Education level codes",
            path="/configuration/v1/education-level",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="benefit_plans",
            name="Benefit Plans",
            description="Benefit plan definitions",
            path="/configuration/v1/benefit-plans",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="pto_types",
            name="PTO Types",
            description="Time off type definitions",
            path="/configuration/v1/pto-types",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="termination_reasons",
            name="Termination Reasons",
            description="Termination reason codes",
            path="/configuration/v1/termination-reason",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
        APIEndpoint(
            id="code_tables",
            name="Code Tables",
            description="List all available code tables",
            path="/configuration/v1/code-tables",
            truth_bucket=TruthBucket.CONFIGURATION,
        ),
    ]
