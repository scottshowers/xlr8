  ...
  return (
    <div>
      <PageHeader
        icon={FolderOpen}
        title="Projects"
        subtitle="Create and manage customer projects"
        breadcrumbs={showForm ? [
          { label: 'Projects', to: '#', onClick: () => { setShowForm(false); setEditingProject(null); } },
          { label: editingProject ? `Edit: ${editingProject.name}` : 'New Project' }
        ] : []}
      />
        ...
        {showForm && (
          <div style={{
            ...
            <form onSubmit={handleSubmit}>
              {/* Row 1: Customer ID and Company */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '1rem' }}>
                <div>
                  <Tooltip title="Customer ID" detail="Your internal project identifier or engagement number. Used to uniquely identify this customer's implementation." action="e.g., MEY1000, ABC-2024-001">
        ...
        {projects.length === 0 ? (
          ...
          <div>
            ...
            <div style={{
              ...
              <Tooltip title="Customer ID" detail="Your internal project identifier or engagement number." position="bottom">
